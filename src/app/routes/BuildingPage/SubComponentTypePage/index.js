...
import SubComponentTypeList from "./SubComponentTypeList";
import AppModuleHeader from "components/AppModuleHeader/index";
import AddSubComponentType from "./AddSubComponentType";
import CustomScrollbars from "util/CustomScrollbars";
import {
    showLoader,
    createNewSubComponent,
    updateSelectedSubComponent,
    deleteSelectedSubComponent
} from "../../../../actions";
import ReactPaginate from "react-paginate";

class SubComponentTypePage extends Component {
    SideBar = () => {
    ...
    onSave = (name) => {
        ...
        this.props.dispatch(createNewSubComponent(body))
    };
    onUpdate = (name) => {
        ...
        this.setState({addState: false, selectedItem: {}});
        this.props.dispatch(showLoader());
        this.props.dispatch(updateSelectedSubComponent(id, body))
    };
    ...
    onDelete = (id) => {
        this.props.dispatch(showLoader());
        this.props.dispatch(deleteSelectedSubComponent(id))
    };
    ...
    constructor(props) {
        super(props);
        this.state = {
            noContentFoundMessage: "No Sub Component found",
            alertMessage: "",
            showMessage: false,
            drawerState: false,
            searchKey: "",
    ...
    render() {
        ...
        const {allSubComponent} = this.props;
        const dataList = searchKey === ""?allSubComponent: this.filterData(allSubComponent, searchKey);
        return (
...
const mapStateToProps = ({settings, subComponent}) => {
    const {width} = settings;
    const {allSubComponent} = subComponent;
    return {width, allSubComponent};
};
export default connect(mapStateToProps)(SubComponentTypePage);
