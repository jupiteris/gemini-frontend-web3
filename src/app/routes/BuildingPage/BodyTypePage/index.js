...
import {
    ...
    deleteSelectedBodyType
} from "../../../../actions";
import ReactPaginate from "react-paginate";

class BodyTypePage extends Component {
    SideBar = () => {
    ...
    onSave = (name) => {
        ...
        this.props.dispatch(createNewBodyType(body))
    };
    onUpdate = (name) => {
        ...
        this.setState({addState: false, selectedItem: {}});
        this.props.dispatch(showLoader());
        this.props.dispatch(updateSelectedBodyType(id, body))
    };
    ...
    onDelete = (id) => {
        this.props.dispatch(showLoader());
        this.props.dispatch(deleteSelectedBodyType(id))
    };
    ...
    render() {
        ...
        const dataList = searchKey === ""?allBodyType: this.filterData(allBodyType, searchKey);
        return (
...
const mapStateToProps = ({settings, bodyType}) => {
    const {width} = settings;
    const {allBodyType} = bodyType;
    return {width, allBodyType};
};
export default connect(mapStateToProps)(BodyTypePage);
