...
import {
    ...
    deleteSelectedBuildingType,
    createNewBuildingType
} from "../../../../actions";
import ReactPaginate from "react-paginate";

class BuildingTypePage extends Component {
    SideBar = () => {
    ...
    onSave = (name) => {
        ...
        this.props.dispatch(createNewBuildingType(body))
    };
    onUpdate = (name) => {
        ...
        this.setState({addState: false, selectedItem: {}});
        this.props.dispatch(showLoader());
        this.props.dispatch(updateSelectedBuildingType(id, body))
    };
    onUpdateActive = (id, active) => {
        const body = {
            building_type: { active }
        };
        this.setState({addState: false, selectedItem: {}});
        this.props.dispatch(showLoader());
        this.props.dispatch(updateSelectedBuildingType(id, body))
    ...
    onDelete = (id) => {
        this.props.dispatch(showLoader());
        this.props.dispatch(deleteSelectedBuildingType(id))
    };
    ...
    constructor(props) {
        super(props);
        this.state = {
            noContentFoundMessage: "No Building Type found",
            alertMessage: "",
            showMessage: false,
            drawerState: false,
            searchKey: "",
    ...
    render() {
        ...
        const dataList = searchKey === ""?allBuildingType: this.filterData(allBuildingType, searchKey);
        return (
...
const mapStateToProps = ({settings, buildingType}) => {
    const {width} = settings;
    const {allBuildingType} = buildingType;
    return {width, allBuildingType};
};
export default connect(mapStateToProps)(BuildingTypePage);
