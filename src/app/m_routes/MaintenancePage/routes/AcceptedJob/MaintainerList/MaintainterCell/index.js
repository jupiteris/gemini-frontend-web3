          ...
          <div style={{ display: "flex", flex: 1, flexWrap: "wrap" }}>
            <div className="row con-inf-mw-100" style={{ flex: 2 }}>
              ...
              >
                {avatar === null || avatar === "" ? (
                  <div
                    className="rounded-circle size-40 bg-blue text-center text-white mx-1 mx-md-3 align-center"
                    style={{ fontSize: 20 }}
                  >
                  ...
                  <img
                    className="rounded-circle size-40 mx-1 mx-md-3 align-center"
                    alt={name}
                    src={avatar}
                  />
                )}
              ...
              <div className="col">
                ...
                <div className="text-muted">
                  <span className="email d-inline-block mr-2">{address}</span>
                </div>
                <div className="text-muted">
            ...
            >
              <div className="text-muted align-center">
                <div className="email d-inline-block mr-2">{"Ability"}</div>
            ...
            <div className="col con-inf-mw-100" style={{ flex: 1 }}>
              <div className="text-muted align-center">
                <div className="email d-inline-block mr-2">{"DURC"}</div>
