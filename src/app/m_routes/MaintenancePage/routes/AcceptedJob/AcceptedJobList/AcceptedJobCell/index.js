...
class AcceptedJobCell extends React.Component {
  ...
  render() {
    ...
    const options = ["Perform", "Reject", "Assign", "Chat"];
    return (
      <div className="contact-item module-list-item">
        ...
        {performDialogVisible && (
          <PerformWork open={performDialogVisible} onClose={this.onClose} />
        )}
        {rejectDialogVisible && (
          <RejectJob open={rejectDialogVisible} onClose={this.onClose} />
        )}
      </div>
    );
  }
